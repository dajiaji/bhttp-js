...
<script type="module">
  import * as bhttp from "https://esm.sh/bhttp-js@0.3.1";
  // ...
</script>
...
<!-- use a specific version -->
<script type="module">
  import * as bhttp from "https://unpkg.com/bhttp-js@0.3.1/esm/mod.js";
  // ...
</script>
```
...
```js
// use a specific version
import * as bhttp from "https://deno.land/x/bhttp@0.3.1/mod.ts";
...
```sh
curl -sS -o $YOUR_SRC_PATH/bhttp.js https://esm.sh/v86/bhttp-js@0.3.1/es2022/bhttp-js.js
# if you want to use a minified version:
curl -sS -o $YOUR_SRC_PATH/bhttp.min.js https://esm.sh/v86/bhttp-js@0.3.1/es2022/bhttp.min.js
```

Emits a single js file by using `deno bundle`:

```sh
deno bundle https://deno.land/x/bhttp@0.3.1/mod.ts > $YOUR_SRC_PATH/bhttp.js
```
...
<html>
  ...
  <body>
    <script type="module">
      import { BHttpEncoder, BHttpDecoder } from 'https://esm.sh/bhttp-js@0.3.1';
...
import {
  BHttpDecoder,
  BHttpEncoder,
} from "https://deno.land/x/bhttp@0.3.1/mod.ts";
